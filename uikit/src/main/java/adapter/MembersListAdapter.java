...
public class MembersListAdapter extends RecyclerView.Adapter<MembersListAdapter.MyViewHolder> implements Filterable {
    ...
    public MembersListAdapter(Context mContext, ArrayList<GetAddNewMember> groupmemberList, String groupType) {
