...
//        Uri destinationUri = Uri.parse(context.getExternalCacheDir().toString()+ download.getDirectory() +download.getName());
///storage/emulated/0/Collaborative Care/Consent Files
        ///storage/emulated/0/Android/data/com.sagesurfer.collaborativecares/cacheauthorization_136.pdf
        DownloadRequest downloadRequest = new DownloadRequest(Uri.parse(download.getUrl()))
                .setRetryPolicy(retryPolicy)
                .setDestinationURI(Uri.parse(context.getExternalCacheDir().toString() + download.getName()))
