...
/*
* This class is used to parse json response for all oauth operations
*/
...
class JsonParser_ {
    ...
    static int authorization(JSONObject jsonObject) {
        if (jsonObject != null) {
            try {
    ...
    static int token(JSONObject jsonObject) {
        if (jsonObject != null) {
            try {
    ...
    static Token_ token_(JSONObject jsonObject) {
        if (jsonObject != null) {
            try {
                if (jsonObject.has(Oauth.ACCESS_TOKEN) && jsonObject.has(Oauth.REFRESH_TOKEN)) {
                    OauthPreferences.save(Oauth.ACCESS_TOKEN, jsonObject.getString(Oauth.ACCESS_TOKEN));
