...
public class MoodCalendarListAdapter extends ArrayAdapter<MoodJournalDataMood_> {
    private static final String TAG = MoodJournalListAdapter.class.getSimpleName();

    public List<MoodJournalDataMood_> calendarList = new ArrayList<MoodJournalDataMood_>();
    private final Activity activity;

    public MoodCalendarListAdapter(Activity activity, List<MoodJournalDataMood_> calendarList) {
        super(activity, 0, calendarList);
    ...
    @Override
    public MoodJournalDataMood_ getItem(int position) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (calendarList.get(position).getStatus() == 1) {
            int size = calendarList.size();
            MoodJournalDataMood_ moodOne = calendarList.get(0);
            try {
                if (calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.happy))
                        || calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.really_happy))
                        || calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.very_happy))
                        || calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.extremely_happy))) {
                    viewHolder.linearLayoutDate.setBackgroundColor(activity.getResources().getColor(R.color.mood_happy));
                } else if (calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.laugh))) {
                    viewHolder.linearLayoutDate.setBackgroundColor(activity.getResources().getColor(R.color.mood_laugh));
                } else if (calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.cry))) {
                    viewHolder.linearLayoutDate.setBackgroundColor(activity.getResources().getColor(R.color.mood_cry));
                } else if (calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.worried)) ||
                        calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.really_worried)) ||
                        calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.very_worried)) ||
                        calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.extremely_worried))) {
                    viewHolder.linearLayoutDate.setBackgroundColor(activity.getResources().getColor(R.color.mood_worried));
                } else if (calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.sad)) ||
                        calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.really_sad)) ||
                        calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.very_sad)) ||
                        calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.extremely_sad))) {
                    viewHolder.linearLayoutDate.setBackgroundColor(activity.getResources().getColor(R.color.mood_sad));
                } else if (calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.angry)) ||
                        calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.really_angry)) ||
                        calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.very_angry)) ||
                        calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.extremely_angry))) {
                    viewHolder.linearLayoutDate.setBackgroundColor(activity.getResources().getColor(R.color.mood_angry));
                } else if (calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.neutral))) {
                    viewHolder.linearLayoutDate.setBackgroundColor(activity.getResources().getColor(R.color.mood_neutral));
                } else if (calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.excited)) ||
                        calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.really_excited)) ||
                        calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.very_excited)) ||
                        calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.extremely_excited))) {
                    viewHolder.linearLayoutDate.setBackgroundColor(activity.getResources().getColor(R.color.mood_excited));
                } else if (calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.anxious)) ||
                        calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.really_anxious)) ||
                        calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.very_anxious)) ||
                        calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.extremely_anxious))) {
                    viewHolder.linearLayoutDate.setBackgroundColor(activity.getResources().getColor(R.color.mood_worried));
                } else if (calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.bored)) ||
                        calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.really_bored)) ||
                        calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.very_bored)) ||
                        calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.extremely_bored))) {
                    viewHolder.linearLayoutDate.setBackgroundColor(activity.getResources().getColor(R.color.mood_bored));
                } else if (calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.fearful)) ||
                        calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.really_fearful)) ||
                        calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.very_fearful)) ||
                        calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.extremely_fearful))) {
                    viewHolder.linearLayoutDate.setBackgroundColor(activity.getResources().getColor(R.color.mood_fearful));
                } else if (calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.confused)) ||
                        calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.really_confused)) ||
                        calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.very_confused)) ||
                        calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.extremely_confused))) {
                    viewHolder.linearLayoutDate.setBackgroundColor(activity.getResources().getColor(R.color.mood_confused));
                } else if (calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.frustrated)) ||
                        calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.really_frustrated)) ||
                        calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.very_frustrated)) ||
                        calendarList.get(0).getMood_name().equalsIgnoreCase(activity.getResources().getString(R.string.extremely_frustrated))) {
            ...
            if (size == 1 && position == 0) {
                ...
                if (calendarList.get(position).getStatus() == 1) {
                    MoodJournalDataMood_ moodTwo = calendarList.get(1);
                ...
                if (calendarList.get(position).getStatus() == 1) {
                    MoodJournalDataMood_ moodThree = calendarList.get(2);
