...
public class TagsEditText extends AutoCompleteTextView {
    ...
    public static final String PRESS_COMMA_TO_BUILD_TAG = ",";
    ...
    private void buildStringWithTags(List<Tag> tags) {
        ...
        if (!TextUtils.isEmpty(mLastString)) {
            getText().append(PRESS_COMMA_TO_BUILD_TAG);
        }
    ...
    private void setTags() {
        ...
        if (str.endsWith(PRESS_COMMA_TO_BUILD_TAG) || (!mIsSpacesAllowedInTags && str.endsWith(mSeparator)) && !isDeleting) {
            buildTags(str);
        }
    ...
    private void updateTags(String newString) {
        ...
        if (!TextUtils.isEmpty(source) && !source.equals(PRESS_COMMA_TO_BUILD_TAG)) {
            boolean isSpan = source.endsWith(PRESS_COMMA_TO_BUILD_TAG) ||
