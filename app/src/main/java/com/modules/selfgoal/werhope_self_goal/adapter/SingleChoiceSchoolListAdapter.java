...
public class SingleChoiceSchoolListAdapter extends ArrayAdapter<Choices_> {
    private final ArrayList<Choices_> categoryArrayList, list;
    private final Context context;

    public SingleChoiceSchoolListAdapter(Context context, ArrayList<Choices_> categoryArrayList) {
