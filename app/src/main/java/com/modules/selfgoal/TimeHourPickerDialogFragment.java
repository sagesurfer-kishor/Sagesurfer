...
public class TimeHourPickerDialogFragment extends DialogFragment implements View.OnClickListener {
    private static final String TAG = TimeHourPickerDialogFragment.class.getSimpleName();
        ...
        switch (v.getId()) {
            ...
            case R.id.button_fragmentselfgoal_timehourpickerdialog_done:
                ...
                if (!isNotify && !isDetails && isPeerAdd) { //Add Peer Note Duration
                    ...
                    PeerAddNoteActivity.peerAddNoteActivity.setTime(hour, GetCounters.checkDigit(Integer.parseInt(minute)), unit);
                }
