...
public class SubmittedFormFragment extends Fragment {

    private static final String TAG = SubmittedFormFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        formTxt.setText("LIST OF SUBMITTED FORMS");
    ...
    private final AdapterView.OnItemClickListener onItemClick = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            detailsIntent.putExtra(Actions_.SUBMITED_LIST, formsArrayList.get(position));
    ...
    private void getSubmittedFormList() {
        showError(true, 20);
        ...
        if (requestBody != null) {
            try {
                ...
                if (response != null) {
                    formsArrayList = Assessment_.parseSubmittedFormsList(response, activity.getApplicationContext(), TAG);
    ...
    public void onResume() {
        ...
        getCounterSubmittedForms();
    }

    private void getCounterSubmittedForms() {
        HashMap<String, String> requestMap = new HashMap<>();
        requestMap.put(General.ACTION, Actions_.SUBMITED_LIST_COUNTER);
        requestMap.put(General.USER_ID, Preferences.get(General.USER_ID));
        ...
        if (requestBody != null) {
            try {
                String response = NetworkCall_.post(url, requestBody, TAG, activity.getApplicationContext(), activity);
                if (response != null) {
                    counterFormList = Assessment_.parseSubmittedFormsCounter(response, activity.getApplicationContext(), TAG);
