...
public class FriendInvitation extends AppCompatActivity {
    ...
    private TextView userName, addedByName, groupName, dateTime, txt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleText.setText(this.getResources().getString(R.string.friend_invitation));
    ...
    private void initUi() {
        ...
        txt.setText("has sent you a friend invitation");
                    ...
                    if (invitationsArrayList.size() > 0) {
                        if (invitationsArrayList.get(0).getStatus() == 1) {
                         ...
                         /*   requestMap = new HashMap<>();
                            requestMap.put(General.ACTION, Actions_.ACCEPT_COMET_CHAT);
                            requestMap.put(General.USER_ID, Preferences.get(General.USER_ID));
                            requestMap.put("send_by", String.valueOf(added_by_id));

                            url = Preferences.get(General.DOMAIN) + "/" + Urls_.MOBILE_INVITATION_OPERATION;
                            requestBody = NetworkCall_.make(requestMap, url, TAG, this, this);
                            Log.e("accpetReuest", requestBody.toString());*/
