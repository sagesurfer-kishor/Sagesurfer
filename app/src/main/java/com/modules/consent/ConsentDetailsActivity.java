...
public class ConsentDetailsActivity extends AppCompatActivity implements View.OnClickListener {
     ...
     */
    private void downloadUsingGlobalDownload() {
    ...
    /**
     * @Author mahesh
     * @Uses It check the user permission status of external storage device
     */
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == 1) {
            ...
            for (int i = 0; i < grantResults.length; i++) {
                ...
                /**
                 * @isDirCreated it will return boolean value if directory get created
                 * @isPermitted it returns the permission status in boolean
                 */
                if (isPermitted) {
                    boolean isDirCreated = MakeDirectory.makeDirectories();
                    if (isDirCreated) {
                        downloadUsingGlobalDownload();
                    }
                } else {
