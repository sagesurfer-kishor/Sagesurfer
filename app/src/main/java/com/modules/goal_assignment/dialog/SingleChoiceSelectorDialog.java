package com.modules.goal_assignment.dialog;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (b != null) {
            ...
            if (Actions_.GET_DISTRICT_LIST.equals(action)) {
                categoryArrayList = (ArrayList<Choices_>) b.getSerializable(General.GET_DISTRICT_LIST);
        ...
        backButton = (AppCompatImageButton) view.findViewById(R.id.single_choice_team_dialog_back);
        backButton.setOnClickListener(this);
        relativeLayoutToolbar = (RelativeLayout) view.findViewById(R.id.relativelayout_toolbar);
        title = (TextView) view.findViewById(R.id.single_choice_team_dialog_title);
        ...
        } else if (action.equalsIgnoreCase(General.SCHOOL_LIST_OF_GRADE)) {
            title.setText(getActivity().getApplicationContext().getResources().getString(R.string.select_grade));
        } else if (action.equalsIgnoreCase(Actions_.GET_STUDENT_UNDER_SCHOOL)) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (Actions_.GET_SCHOOL_LIST.equals(action)) {
