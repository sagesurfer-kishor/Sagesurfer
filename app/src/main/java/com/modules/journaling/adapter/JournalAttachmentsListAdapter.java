...
/**
 * Created by Kailash Karankal on 12/12/2019.
 */
public class JournalAttachmentsListAdapter extends ArrayAdapter<Attachment_> {

    private final List<Attachment_> attachmentList;
    private final Activity activity;

    public JournalAttachmentsListAdapter(Activity activity, List<Attachment_> attachmentList) {
