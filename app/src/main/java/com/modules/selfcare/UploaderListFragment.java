...
public class UploaderListFragment extends Fragment implements View.OnClickListener {

    private static final String TAG = UploaderListFragment.class.getSimpleName();
