...
class UploadContentListAdapter extends ArrayAdapter<CareUploaded_> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (view == null) {
            ...
            /**
             * @error : Crash issue becuase of ClassCastException
             */
            viewHolder.likeIcon = (AppCompatImageButton) view.findViewById(R.id.btn_like);
    ...
    private class ViewHolder {
        ...
        ImageView thumbnail;
        AppCompatImageView icon, commentIcon;
        AppCompatImageButton likeIcon;
