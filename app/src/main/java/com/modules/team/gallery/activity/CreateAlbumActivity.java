 ...
 */
public class CreateAlbumActivity extends AppCompatActivity implements GalleryMultipleImageAdapter.SelectedDeleteImageAdapterListener {
    ...
    private ArrayList<Gallery_> galleryArrayList;
    private TextView countImg, hintTxt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        window.setStatusBarColor(ContextCompat.getColor(CreateAlbumActivity.this, GetColor.getHomeIconBackgroundColorColorParse(false)));
        ...
        mLayoutManager = new GridLayoutManager(CreateAlbumActivity.this, 2);
    ...
    private class UploadFile extends AsyncTask<String, Void, Integer> {
        ...
        protected void onPreExecute() {
            ...
            showLoader.showUploadDialog(CreateAlbumActivity.this);
        }
        ...
        protected Integer doInBackground(String... params) {
            ...
            try {
                String response = FileUpload.uploadFile(path, file_name, user_id, url,
                        Actions_.FMS, getApplicationContext(), CreateAlbumActivity.this);
                if (response != null) {
            ...
            switch (result) {
                case 1:
                    ...
                    if (imagesArrayList.size() >= 1 && imagesArrayList.size() <= 10) {
                        ...
                        galleryMultipleImageAdapter = new GalleryMultipleImageAdapter(CreateAlbumActivity.this, 1, imagesArrayList, CreateAlbumActivity.this);
    ...
    private class RemoveAttachment extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            RequestBody getBody = new FormBody.Builder()
                    ...
                    .build();
            try {
                MakeCall.postNormal(Preferences.get(General.DOMAIN).replaceAll(General.INSATNCE_NAME, "") + Urls_.MOBILE_UPLOADER, getBody, TAG, CreateAlbumActivity.this);
            } catch (Exception e) {
                e.printStackTrace();
            }
            return null;
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            ShowToast.toast("Removed", CreateAlbumActivity.this);
    ...
    private void createGallery() {
        ...
        if (requestBody != null) {
            try {
                ...
                if (response != null) {
                    galleryArrayList = TeamDetails_.parseCreateAlbumGallery(response, getApplicationContext(), TAG);
                    if (galleryArrayList.size() > 0) {
                        if (galleryArrayList.get(0).getStatus() == 1) {
                            msg = galleryArrayList.get(0).getMessage();
                            Toast.makeText(CreateAlbumActivity.this, msg, Toast.LENGTH_LONG).show();
                        }
                    }
                }
            } catch (Exception e) {
