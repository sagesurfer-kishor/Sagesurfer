...
public class MhawCaseloadListNewAdapter extends RecyclerView.Adapter<MhawCaseloadListNewAdapter.MyViewHolder> {
    private static final String TAG = MhawCaseloadListNewAdapter.class.getSimpleName();
    ...
    public MhawCaseloadListNewAdapter(Activity activity, ArrayList<Caseload_> caseloadList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView;
        if (Preferences.get(General.DOMAIN_CODE).equalsIgnoreCase(activity.getResources().getString(R.string.sage026)) ||
    ...
    public void onBindViewHolder(final MyViewHolder viewHolder, final int position) {
        ...
        if (Preferences.get(General.DOMAIN_CODE).equalsIgnoreCase(activity.getResources().getString(R.string.sage023))) {
            ...
            if (caseloadList.get(position).getLast_progress_date().equalsIgnoreCase("N/A")) {
                viewHolder.lastNoteDate.setText("N/A");
            } else {
                viewHolder.lastNoteDate.setText(GetTime.dateValue(Long.parseLong(caseloadList.get(position).getLast_progress_date())));
            }
            ...
            if (caseloadList.get(position).getLast_progress_date() == null || caseloadList.get(position).getLast_team_interaction().trim().length() <= 0) {
                viewHolder.lastNoteDate.setText("N/A");
            } else {
...
//                viewHolder.lastNoteDate.setText(caseloadList.get(position).getContacted_last());
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        final TextView grade, staff, gradeDisplayName, staffDisplayName, lastNoteDate, lastMood, teamName;
