package com.modules.caseload.werhope.fragment;
...
public class TimeHourPickerFragment extends DialogFragment implements View.OnClickListener {
    private static final String TAG = TimeHourPickerFragment.class.getSimpleName();
    ...
    private TimeHourPickerFragmentInterface goalDetailsInterface;
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            goalDetailsInterface = (TimeHourPickerFragmentInterface) activity;
    ...
    public interface TimeHourPickerFragmentInterface {
